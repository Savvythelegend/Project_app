...
if direction >= (360-ddeg) and direction < (0+ddeg):
    ...
    common_dir = "N/NW"
elif direction >= 310 and direction < 330:
    common_dir = "NW"
elif direction >= 290 and direction < 310:
    common_dir = "W/NW"
elif direction >= 260 and direction < 290:
    common_dir = "W"
elif direction >= 240 and direction < 260:
    common_dir = "W/SW"
elif direction >= 220 and direction < 240:
    common_dir = "SW"
elif direction >= 200 and direction < 220:
    common_dir = "S/SW"
elif direction >= 170 and direction < 200:
    common_dir = "S"
elif direction >= 150 and direction < 170:
    common_dir = "S/SE"
elif direction >= 130 and direction < 150:
    common_dir = "SE"
elif direction >= 110 and direction < 130:
    common_dir = "E/SE"
elif direction >= 80 and direction < 110:
    common_dir = "E"
