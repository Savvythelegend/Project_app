...
if direction >= 350 or direction < 10:
    common_dir = "N"
elif direction >= 330 or direction < 350:
    common_dir = "N/NW"
elif direction >= 310 or direction < 330:
    common_dir = "NW"
elif direction >= 290 or direction < 310:
    common_dir = "W/NW"
elif direction >= 260 or direction < 290:
    common_dir = "W"
elif direction >= 240 or direction < 260:
    common_dir = "W/SW"
elif direction >= 220 or direction < 240:
    common_dir = "SW"
elif direction >= 200 or direction < 220:
    common_dir = "S/SW"
elif direction >= 170 or direction < 200:
    common_dir = "S"
elif direction >= 150 or direction < 170:
    common_dir = "S/SE"
elif direction >= 130 or direction < 150:
    common_dir = "SE"
elif direction >= 110 or direction < 130:
    common_dir = "E/SE"
elif direction >= 80 or direction < 110:
    common_dir = "E"
elif direction >= 60 or direction < 80:
    common_dir = "E/NE"
elif direction >= 40 or direction < 60:
    common_dir = "NE"
elif direction >= 20 or direction < 40:
    common_dir = "N/NE"
